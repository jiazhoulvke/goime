...
// validSyllables is a set of all valid Mandarin pinyin syllables.
var validSyllables = map[string]struct{}{
	"a": {}, "ai": {}, "an": {}, "ang": {}, "ao": {},
	...
	"na": {}, "nai": {}, "nan": {}, "nang": {}, "nao": {}, "ne": {}, "nei": {}, "nen": {}, "neng": {}, "ng": {}, "ni": {}, "nian": {}, "niang": {}, "niao": {}, "nie": {}, "nin": {}, "ning": {}, "niu": {}, "nong": {}, "nou": {}, "nu": {}, "nv": {}, "nuan": {}, "nve": {}, "nuo": {},
	"o": {}, "ou": {},
...
// IsValidSyllable returns true if s is a valid Mandarin pinyin syllable.
func IsValidSyllable(s string) bool {
	_, ok := validSyllables[s]
	return ok
}

// AllSyllables returns a slice of all valid Mandarin pinyin syllables.
func AllSyllables() []string {
	syllables := make([]string, 0, len(validSyllables))
	for s := range validSyllables {
